...
Geprüft wird ob für jedes Element im HTML-Quellcode folgendes gewährleistet ist:
...
Parsing-Fehler können Browsern und Screenreadern den Umgang mit der Seite erschweren.
...
. Prüfen, ob nach der Anwendung des Bookmarklets keine Fehler mehr angezeigt werden.
  Falls noch Fehler angezeigt werden, prüfen ob es sich jeweils um einen Verstoß gegen einer der folgenden vier Kriterien handelt:
  * sie besitzen vollständige Start- und Endtags
  * sie sind gemäß Spezifikation korrekt verschachtelt
  * sie enthalten keine doppelten Attribute
...
* Die Prüfung mit dem W3C-Validator und nach Anwendung des WCAG parsing only Bookmarklet zeigt keine Fehler gegen eine der vier genannten Kriterien auf.

==== Nicht erfüllt

* Es ist mindestens ein Fehler im gerenderten Quellcode vorhanden, der gegen eine der vier Kriterien verstößt.
